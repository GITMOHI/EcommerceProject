...
exports.createOrder = async (req, res) => {
    try {
        ...
        const data = {
            ...
            success_url: `https://ecommerce-project-gamma-seven.vercel.app/payment/success/${tran_id}`,
            fail_url: `https://ecommerce-project-gamma-seven.vercel.app/payment/failed/${tran_id}`,
